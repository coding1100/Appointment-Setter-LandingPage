export const CleaningData = {
  ...
  featureSection: {
    headline: "Challenges Cleaning Face Booking New Leads",
    problemCards: [
      {
  ...
  faqSection: [
    ...
    {
      question:
        "Can the AI integrate with my existing tools like ServiceTitan or Housecall Pro?",
      answer:
        "Yes. The AI connects seamlessly with platforms such as ServiceTitan, Housecall Pro, and Google Calendar to sync schedules, prevent double-booking, and update job statuses in real time.",
    },
    {
      question: "Will the AI answer calls while my team is busy on-site?",
      answer:
    ...
    {
      question:
        "Does the AI help increase leads and revenue for cleaning services?",
      answer:
        "Yes. By responding instantly, qualifying prospects, and following up automatically, the AI captures more opportunities and helps boost both leads and revenue.",
    },
  ],
};

    ...
    <nav className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-[#050915]/70 py-6 backdrop-blur-2xl">
      <div className="flex items-center justify-between sm:px-10 px-4 lg:container lg:mx-auto">
        ...
        <button
          ...
          className="relative inline-flex items-center gap-2 rounded-full bg-[#38E0FF] px-6 py-2 text-sm font-semibold text-[#021026] shadow-[0_18px_45px_rgba(56,224,255,0.35)] transition-all hover:shadow-[0_24px_60px_rgba(56,224,255,0.45)] cursor-pointer"
        >
